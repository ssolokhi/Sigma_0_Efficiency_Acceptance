...
def polynome(x: float, params: list) -> float:
...
def gaussian_and_polynome(x: float, params: list) -> float:
	intergal, mu, sigma, *polynome_params = params
	return gaussian(x, [intergal, mu, sigma]) + polynome(x, polynome_params)
